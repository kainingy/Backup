	...
	public function widget( $args, $instance ) {
		...
		<?php else : ?>
			...
			<form name="bp-login-form" id="bp-login-widget-form" class="standard-form" action="<?php echo esc_url( site_url( 'wp-login.php', 'login_post' ) ); ?>" method="post">
				...
				<input type="text" name="log"  style="color:black" id="bp-login-widget-user-login" class="input" value="" />

				<label for="bp-login-widget-user-pass"><?php _e( 'Password', 'buddypress' ); ?></label>
				<input type="password" name="pwd" style="color:black"  id="bp-login-widget-user-pass" class="input" value=""  />
				...
				<input type="submit" style="color:black" name="wp-submit" id="bp-login-widget-submit" value="<?php esc_attr_e( 'Log In', 'buddypress' ); ?>" />

				<?php if ( bp_get_signup_allowed() ) : ?>

					<span class="bp-login-widget-register-link"><a href= "http://ucicssa.org/reguci/">Register</a></span>
