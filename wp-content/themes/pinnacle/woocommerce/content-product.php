...
$product_column = $woocommerce_loop['columns']; 
		                if ($product_column == '3'){ $itemsize = 'tcol-md-4 tcol-sm-4 tcol-xs-6 tcol-ss-12'; $productimgwidth = 400;} 
...
<div class="<?php echo $itemsize;?> kad_product">
	...
	<a href="<?php the_permalink(); ?>" class="product_item_link product_img_link">
        ...
        <div class="product_details_case clearfix">
			...
			<div class="product_excerpt"><?php global $post; if ($post->post_excerpt){echo do_shortcode(wpautop(wptexturize($post->post_excerpt))); } else {the_excerpt();} ?></div>
		</div>
