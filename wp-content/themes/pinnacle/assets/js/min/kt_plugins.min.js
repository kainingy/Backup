 ...
 */
function(t){t.fn.extend({customSelect:function(e){if("undefined"==typeof document.body.style.maxHeight)return this;var i={customClass:"customSelect",mapClass:!0,mapStyle:!0},e=t.extend(i,e),n=e.customClass,o=function(e,i){var n=e.find(":selected"),o=i.children(":first"),r=n.html()||"&nbsp;";o.html(r),n.attr("disabled")?i.addClass(s("DisabledOption")):i.removeClass(s("DisabledOption")),setTimeout(function(){i.removeClass(s("Open")),t(document).off("mouseup."+s("Open"))},60)},s=function(t){return n+t};return this.each(function(){var i=t(this),r=t("<span />").addClass(s("Inner")),a=t("<span />"),c=i.position();i.after(a.append(r)),a.addClass(n),e.mapClass&&a.addClass(i.attr("class")),e.mapStyle&&a.attr("style",i.attr("style")),i.addClass("hasCustomSelect").on("update",function(){o(i,a);var t=parseInt(i.outerWidth(),10)-(parseInt(a.outerWidth(),10)-parseInt(a.width(),10));a.css({display:"inline-block"});var e=a.outerHeight();i.attr("disabled")?a.addClass(s("Disabled")):a.removeClass(s("Disabled")),r.css({width:t,display:"inline-block"}),i.css({"-webkit-appearance":"menulist-button",width:a.outerWidth(),position:"absolute",opacity:0,height:e,fontSize:a.css("font-size"),left:c.left,top:c.top})}).on("change",function(){a.addClass(s("Changed")),o(i,a)}).on("keyup",function(t){a.hasClass(s("Open"))?(13==t.which||27==t.which||9==t.which)&&o(i,a):(i.blur(),i.focus())}).on("mousedown",function(t){a.removeClass(s("Changed"))}).on("mouseup",function(e){a.hasClass(s("Open"))||(t("."+s("Open")).not(a).length>0&&"undefined"!=typeof InstallTrigger?i.focus():(a.addClass(s("Open")),e.stopPropagation(),t(document).one("mouseup."+s("Open"),function(e){e.target!=i.get(0)&&t.inArray(e.target,i.find("*").get())<0?i.blur():o(i,a)})))}).focus(function(){a.removeClass(s("Changed")).addClass(s("Focus"))}).blur(function(){a.removeClass(s("Focus")+" "+s("Open"))}).hover(function(){a.addClass(s("Hover"))},function(){a.removeClass(s("Hover"))}).trigger("update")})}})}(jQuery),function(t){"function"==typeof define&&define.amd&&define.amd.jQuery?define(["jquery"],t):t(jQuery)}(function(t){function e(e){return!e||void 0!==e.allowPageScroll||void 0===e.tswipe&&void 0===e.tswipeStatus||(e.allowPageScroll=l),void 0!==e.click&&void 0===e.tap&&(e.tap=e.click),e||(e={}),e=t.extend({},t.fn.tswipe.defaults,e),this.each(function(){var n=t(this),o=n.data(T);o||(o=new i(this,e),n.data(T,o))})}function i(e,i){function P(e){if(!(ce()||t(e.target).closest(i.excludedElements,qe).length>0)){var n=e.originalEvent?e.originalEvent:e,o,s=S?n.touches[0]:n;return Re=_,S?Ue=n.touches.length:e.preventDefault(),Le=0,je=null,Fe=null,Ae=0,ze=0,De=0,He=1,Be=0,Ve=fe(),We=me(),re(),!S||Ue===i.fingers||i.fingers===b||W()?(ue(0,s),Qe=Se(),2==Ue&&(ue(1,n.touches[1]),ze=De=ye(Ve[0].start,Ve[1].start)),(i.tswipeStatus||i.pinchStatus)&&(o=L(n,Re))):o=!1,o===!1?(Re=x,L(n,Re),o):(le(!0),null)}}function I(t){var e=t.originalEvent?t.originalEvent:t;if(Re!==C&&Re!==x&&!ae()){var n,o=S?e.touches[0]:e,s=pe(o);if(Ze=Se(),S&&(Ue=e.touches.length),Re=w,2==Ue&&(0==ze?(ue(1,e.touches[1]),ze=De=ye(Ve[0].start,Ve[1].start)):(pe(e.touches[1]),De=ye(Ve[0].end,Ve[1].end),Fe=we(Ve[0].end,Ve[1].end)),He=_e(ze,De),Be=Math.abs(ze-De)),Ue===i.fingers||i.fingers===b||!S||W()){if(je=xe(s.start,s.end),B(t,je),Le=Ce(s.start,s.end),Ae=be(),ge(je,Le),(i.tswipeStatus||i.pinchStatus)&&(n=L(e,Re)),!i.triggerOnTouchEnd||i.triggerOnTouchLeave){var r=!0;if(i.triggerOnTouchLeave){var a=Te(this);r=Pe(s.end,a)}!i.triggerOnTouchEnd&&r?Re=N(w):i.triggerOnTouchLeave&&!r&&(Re=N(C)),(Re==x||Re==C)&&L(e,Re)}}else Re=x,L(e,Re);n===!1&&(Re=x,L(e,Re))}}function k(t){var e=t.originalEvent;return S&&e.touches.length>0?(se(),!0):(ae()&&(Ue=Ke),t.preventDefault(),Ze=Se(),Ae=be(),z()?(Re=x,L(e,Re)):i.triggerOnTouchEnd||0==i.triggerOnTouchEnd&&Re===w?(Re=C,L(e,Re)):!i.triggerOnTouchEnd&&G()?(Re=C,j(e,Re,f)):Re===w&&(Re=x,L(e,Re)),le(!1),null)}function M(){Ue=0,Ze=0,Qe=0,ze=0,De=0,He=1,re(),le(!1)}function O(t){var e=t.originalEvent;i.triggerOnTouchLeave&&(Re=N(C),L(e,Re))}function E(){qe.unbind(ke,P),qe.unbind(Ne,M),qe.unbind(Me,I),qe.unbind(Oe,k),Ee&&qe.unbind(Ee,O),le(!1)}function N(t){var e=t,n=H(),o=A(),s=z();return!n||s?e=x:!o||t!=w||i.triggerOnTouchEnd&&!i.triggerOnTouchLeave?!o&&t==C&&i.triggerOnTouchLeave&&(e=x):e=C,e}function L(t,e){var i=void 0;return V()||U()?i=j(t,e,p):(q()||W())&&i!==!1&&(i=j(t,e,d)),ne()&&i!==!1?i=j(t,e,g):oe()&&i!==!1?i=j(t,e,h):ie()&&i!==!1&&(i=j(t,e,f)),e===x&&M(t),e===C&&(S?0==t.touches.length&&M(t):M(t)),i}function j(e,l,u){var m=void 0;if(u==p){if(qe.trigger("tswipeStatus",[l,je||null,Le||0,Ae||0,Ue]),i.tswipeStatus&&(m=i.tswipeStatus.call(qe,e,l,je||null,Le||0,Ae||0,Ue),m===!1))return!1;if(l==C&&R()){if(qe.trigger("tswipe",[je,Le,Ae,Ue]),i.tswipe&&(m=i.tswipe.call(qe,e,je,Le,Ae,Ue),m===!1))return!1;switch(je){case n:qe.trigger("tswipeLeft",[je,Le,Ae,Ue]),i.tswipeLeft&&(m=i.tswipeLeft.call(qe,e,je,Le,Ae,Ue));break;case o:qe.trigger("tswipeRight",[je,Le,Ae,Ue]),i.tswipeRight&&(m=i.tswipeRight.call(qe,e,je,Le,Ae,Ue));break;case s:qe.trigger("tswipeUp",[je,Le,Ae,Ue]),i.tswipeUp&&(m=i.tswipeUp.call(qe,e,je,Le,Ae,Ue));break;case r:qe.trigger("tswipeDown",[je,Le,Ae,Ue]),i.tswipeDown&&(m=i.tswipeDown.call(qe,e,je,Le,Ae,Ue))}}}if(u==d){if(qe.trigger("pinchStatus",[l,Fe||null,Be||0,Ae||0,Ue,He]),i.pinchStatus&&(m=i.pinchStatus.call(qe,e,l,Fe||null,Be||0,Ae||0,Ue,He),m===!1))return!1;if(l==C&&F())switch(Fe){case a:qe.trigger("pinchIn",[Fe||null,Be||0,Ae||0,Ue,He]),i.pinchIn&&(m=i.pinchIn.call(qe,e,Fe||null,Be||0,Ae||0,Ue,He));break;case c:qe.trigger("pinchOut",[Fe||null,Be||0,Ae||0,Ue,He]),i.pinchOut&&(m=i.pinchOut.call(qe,e,Fe||null,Be||0,Ae||0,Ue,He))}}return u==f?(l===x||l===C)&&(clearTimeout(Xe),K()&&!J()?(Ye=Se(),Xe=setTimeout(t.proxy(function(){Ye=null,qe.trigger("tap",[e.target]),i.tap&&(m=i.tap.call(qe,e,e.target))},this),i.doubleTapThreshold)):(Ye=null,qe.trigger("tap",[e.target]),i.tap&&(m=i.tap.call(qe,e,e.target)))):u==g?(l===x||l===C)&&(clearTimeout(Xe),Ye=null,qe.trigger("doubletap",[e.target]),i.doubleTap&&(m=i.doubleTap.call(qe,e,e.target))):u==h&&(l===x||l===C)&&(clearTimeout(Xe),Ye=null,qe.trigger("longtap",[e.target]),i.longTap&&(m=i.longTap.call(qe,e,e.target))),m}function A(){var t=!0;return null!==i.threshold&&(t=Le>=i.threshold),t}function z(){var t=!1;return null!==i.cancelThreshold&&null!==je&&(t=he(je)-Le>=i.cancelThreshold),t}function D(){return null!==i.pinchThreshold?Be>=i.pinchThreshold:!0}function H(){var t;return t=i.maxTimeThreshold&&Ae>=i.maxTimeThreshold?!1:!0}function B(t,e){if(i.allowPageScroll===l||W())t.preventDefault();else{var a=i.allowPageScroll===u;switch(e){case n:(i.tswipeLeft&&a||!a&&i.allowPageScroll!=m)&&t.preventDefault();break;case o:(i.tswipeRight&&a||!a&&i.allowPageScroll!=m)&&t.preventDefault();break;case s:(i.tswipeUp&&a||!a&&i.allowPageScroll!=v)&&t.preventDefault();break;case r:(i.tswipeDown&&a||!a&&i.allowPageScroll!=v)&&t.preventDefault()}}}function F(){var t=Q(),e=Z(),i=D();return t&&e&&i}function W(){return!!(i.pinchStatus||i.pinchIn||i.pinchOut)}function q(){return!(!F()||!W())}function R(){var t=H(),e=A(),i=Q(),n=Z(),o=z(),s=!o&&n&&i&&e&&t;return s}function U(){return!!(i.tswipe||i.tswipeStatus||i.tswipeLeft||i.tswipeRight||i.tswipeUp||i.tswipeDown)}function V(){return!(!R()||!U())}function Q(){return Ue===i.fingers||i.fingers===b||!S}function Z(){return 0!==Ve[0].end.x}function G(){return!!i.tap}function K(){return!!i.doubleTap}function Y(){return!!i.longTap}function X(){if(null==Ye)return!1;var t=Se();return K()&&t-Ye<=i.doubleTapThreshold}function J(){return X()}function te(){return!(1!==Ue&&S||!isNaN(Le)&&0!==Le)}function ee(){return Ae>i.longTapThreshold&&y>Le}function ie(){return!(!te()||!G())}function ne(){return!(!X()||!K())}function oe(){return!(!ee()||!Y())}function se(){Ge=Se(),Ke=event.touches.length+1}function re(){Ge=0,Ke=0}function ae(){var t=!1;if(Ge){var e=Se()-Ge;e<=i.fingerReleaseThreshold&&(t=!0)}return t}function ce(){return!(qe.data(T+"_intouch")!==!0)}function le(t){t===!0?(qe.bind(Me,I),qe.bind(Oe,k),Ee&&qe.bind(Ee,O)):(qe.unbind(Me,I,!1),qe.unbind(Oe,k,!1),Ee&&qe.unbind(Ee,O,!1)),qe.data(T+"_intouch",t===!0)}function ue(t,e){var i=void 0!==e.identifier?e.identifier:0;return Ve[t].identifier=i,Ve[t].start.x=Ve[t].end.x=e.pageX||e.clientX,Ve[t].start.y=Ve[t].end.y=e.pageY||e.clientY,Ve[t]}function pe(t){var e=void 0!==t.identifier?t.identifier:0,i=de(e);return i.end.x=t.pageX||t.clientX,i.end.y=t.pageY||t.clientY,i}function de(t){for(var e=0;e<Ve.length;e++)if(Ve[e].identifier==t)return Ve[e]}function fe(){for(var t=[],e=0;5>=e;e++)t.push({start:{x:0,y:0},end:{x:0,y:0},identifier:0});return t}function ge(t,e){e=Math.max(e,he(t)),We[t].distance=e}function he(t){return We[t]?We[t].distance:void 0}function me(){var t={};return t[n]=ve(n),t[o]=ve(o),t[s]=ve(s),t[r]=ve(r),t}function ve(t){return{direction:t,distance:0}}function be(){return Ze-Qe}function ye(t,e){var i=Math.abs(t.x-e.x),n=Math.abs(t.y-e.y);return Math.round(Math.sqrt(i*i+n*n))}function _e(t,e){var i=e/t*1;return i.toFixed(2)}function we(){return 1>He?c:a}function Ce(t,e){return Math.round(Math.sqrt(Math.pow(e.x-t.x,2)+Math.pow(e.y-t.y,2)))}function $e(t,e){var i=t.x-e.x,n=e.y-t.y,o=Math.atan2(n,i),s=Math.round(180*o/Math.PI);return 0>s&&(s=360-Math.abs(s)),s}function xe(t,e){var i=$e(t,e);return 45>=i&&i>=0?n:360>=i&&i>=315?n:i>=135&&225>=i?o:i>45&&135>i?r:s}function Se(){var t=new Date;return t.getTime()}function Te(e){e=t(e);var i=e.offset(),n={left:i.left,right:i.left+e.outerWidth(),top:i.top,bottom:i.top+e.outerHeight()};return n}function Pe(t,e){return t.x>e.left&&t.x<e.right&&t.y>e.top&&t.y<e.bottom}var Ie=S||!i.fallbackToMouseEvents,ke=Ie?"touchstart":"mousedown",Me=Ie?"touchmove":"mousemove",Oe=Ie?"touchend":"mouseup",Ee=Ie?null:"mouseleave",Ne="touchcancel",Le=0,je=null,Ae=0,ze=0,De=0,He=1,Be=0,Fe=0,We=null,qe=t(e),Re="start",Ue=0,Ve=null,Qe=0,Ze=0,Ge=0,Ke=0,Ye=0,Xe=null;try{qe.bind(ke,P),qe.bind(Ne,M)}catch(Je){t.error("events not supported "+ke+","+Ne+" on jQuery.tswipe")}this.enable=function(){return qe.bind(ke,P),qe.bind(Ne,M),qe},this.disable=function(){return E(),qe},this.destroy=function(){return E(),qe.data(T,null),qe},this.option=function(e,n){if(void 0!==i[e]){if(void 0===n)return i[e];i[e]=n}else t.error("Option "+e+" does not exist on jQuery.tswipe.options");return null}}var n="left",o="right",s="up",r="down",a="in",c="out",l="none",u="auto",p="tswipe",d="pinch",f="tap",g="doubletap",h="longtap",m="horizontal",v="vertical",b="all",y=10,_="start",w="move",C="end",x="cancel",S="ontouchstart"in window,T="TouchtSwipe",P={fingers:1,threshold:75,cancelThreshold:null,pinchThreshold:20,maxTimeThreshold:null,fingerReleaseThreshold:250,longTapThreshold:500,doubleTapThreshold:200,tswipe:null,tswipeLeft:null,tswipeRight:null,tswipeUp:null,tswipeDown:null,tswipeStatus:null,pinchIn:null,pinchOut:null,pinchStatus:null,click:null,tap:null,doubleTap:null,longTap:null,triggerOnTouchEnd:!0,triggerOnTouchLeave:!1,allowPageScroll:"auto",fallbackToMouseEvents:!0,excludedElements:"label, button, input, select, textarea, a, .notSwipe"};t.fn.tswipe=function(i){var n=t(this),o=n.data(T);if(o&&"string"==typeof i){if(o[i])return o[i].apply(this,Array.prototype.slice.call(arguments,1));t.error("Method "+i+" does not exist on jQuery.tswipe")}else if(!(o||"object"!=typeof i&&i))return e.apply(this,arguments);return n},t.fn.tswipe.defaults=P,t.fn.tswipe.phases={PHASE_START:_,PHASE_MOVE:w,PHASE_END:C,PHASE_CANCEL:x},t.fn.tswipe.directions={LEFT:n,RIGHT:o,UP:s,DOWN:r,IN:a,OUT:c},t.fn.tswipe.pageScroll={NONE:l,HORIZONTAL:m,VERTICAL:v,AUTO:u},t.fn.tswipe.fingers={ONE:1,TWO:2,THREE:3,ALL:b}}),function($){var t=$.event,e,i;e=t.special.debouncedresize={setup:function(){$(this).on("resize",e.handler)},teardown:function(){$(this).off("resize",e.handler)},handler:function(n,o){var s=this,r=arguments,a=function(){n.type="debouncedresize",t.dispatch.apply(s,r)};i&&clearTimeout(i),o?a():i=setTimeout(a,e.threshold)},threshold:150}}(jQuery),function(t,e){function i(){L||(L={verbose:!1,queryLimit:{attempt:5,delay:250,random:250},classes:{Map:google.maps.Map,Marker:google.maps.Marker,InfoWindow:google.maps.InfoWindow,Circle:google.maps.Circle,Rectangle:google.maps.Rectangle,OverlayView:google.maps.OverlayView,StreetViewPanorama:google.maps.StreetViewPanorama,KmlLayer:google.maps.KmlLayer,TrafficLayer:google.maps.TrafficLayer,BicyclingLayer:google.maps.BicyclingLayer,GroundOverlay:google.maps.GroundOverlay,StyledMapType:google.maps.StyledMapType,ImageMapType:google.maps.ImageMapType},map:{mapTypeId:google.maps.MapTypeId.ROADMAP,center:[46.578498,2.457275],zoom:2},overlay:{pane:"floatPane",content:"",offset:{x:0,y:0}},geoloc:{getCurrentPosition:{maximumAge:6e4,timeout:5e3}}})}function n(t,i){return t!==e?t:"gmap3_"+(i?j+1:++j)}function o(t){var e=function(t){return parseInt(t,10)},i=google.maps.version.split(".").map(e),n;for(t=t.split(".").map(e),n=0;n<t.length;n++){if(!i.hasOwnProperty(n))return!1;if(i[n]<t[n])return!1}return!0}function s(e,i,n,o,s){if(i.todo.events||i.todo.onces){var r={id:o,data:i.todo.data,tag:i.todo.tag};i.todo.events&&t.each(i.todo.events,function(i,o){var a=e,c=o;t.isArray(o)&&(a=o[0],c=o[1]),google.maps.event.addListener(n,i,function(t){c.apply(a,[s?s:n,t,r])})}),i.todo.onces&&t.each(i.todo.onces,function(i,o){var a=e,c=o;t.isArray(o)&&(a=o[0],c=o[1]),google.maps.event.addListenerOnce(n,i,function(t){c.apply(a,[s?s:n,t,r])})})}}function r(){var t=[];this.empty=function(){return!t.length},this.add=function(e){t.push(e)},this.get=function(){return t.length?t[0]:!1},this.ack=function(){t.shift()}}function a(e,i,n){function o(t){var e={};return e[t]={},e}function s(){var t;for(t in n)if(!(t in r))return t}var r={},a=this,c,l={latLng:{map:!1,marker:!1,infowindow:!1,circle:!1,overlay:!1,getlatlng:!1,getmaxzoom:!1,getelevation:!1,streetviewpanorama:!1,getaddress:!0},geoloc:{getgeoloc:!0}};"string"==typeof n&&(n=o(n)),this.run=function(){for(var o,a;o=s();){if("function"==typeof e[o])return c=o,a=t.extend(!0,{},L[o]||{},n[o].options||{}),void(o in l.latLng?n[o].values?M(n[o].values,e,e[o],{todo:n[o],opts:a,session:r}):k(e,e[o],l.latLng[o],{todo:n[o],opts:a,session:r}):o in l.geoloc?O(e,e[o],{todo:n[o],opts:a,session:r}):e[o].apply(e,[{todo:n[o],opts:a,session:r}]));r[o]=null}i.apply(e,[n,r])},this.ack=function(t){r[c]=t,a.run.apply(a,[])}}function c(t){var e,i=[];for(e in t)i.push(e);return i}function l(e,i){var n={};if(e.todo)for(var o in e.todo)"options"!==o&&"values"!==o&&(n[o]=e.todo[o]);var s,r=["data","tag","id","events","onces"];for(s=0;s<r.length;s++)u(n,r[s],i,e.todo);return n.options=t.extend({},e.opts||{},i.options||{}),n}function u(t,e){for(var i=2;i<arguments.length;i++)if(e in arguments[i])return void(t[e]=arguments[i][e])}function p(){var t=[];this.get=function(e){if(t.length){var i,n,o,s,r,a=c(e);for(i=0;i<t.length;i++){for(s=t[i],r=a.length==s.keys.length,n=0;n<a.length&&r;n++)o=a[n],r=o in s.request,r&&(r="object"==typeof e[o]&&"equals"in e[o]&&"function"==typeof e[o]?e[o].equals(s.request[o]):e[o]===s.request[o]);if(r)return s.results}}},this.store=function(e,i){t.push({request:e,keys:c(e),results:i})}}function d(e,i,n,o){var s=this,r=[];L.classes.OverlayView.call(this),this.setMap(e),this.onAdd=function(){var e=this.getPanes();i.pane in e&&t(e[i.pane]).append(o),t.each("dblclick click mouseover mousemove mouseout mouseup mousedown".split(" "),function(e,i){r.push(google.maps.event.addDomListener(o[0],i,function(e){t.Event(e).stopPropagation(),google.maps.event.trigger(s,i,[e]),s.draw()}))}),r.push(google.maps.event.addDomListener(o[0],"contextmenu",function(e){t.Event(e).stopPropagation(),google.maps.event.trigger(s,"rightclick",[e]),s.draw()}))},this.getPosition=function(){return n},this.draw=function(){var t=this.getProjection().fromLatLngToDivPixel(n);o.css("left",t.x+i.offset.x+"px").css("top",t.y+i.offset.y+"px")},this.onRemove=function(){for(var t=0;t<r.length;t++)google.maps.event.removeListener(r[t]);o.remove()},this.hide=function(){o.hide()},this.show=function(){o.show()},this.toggle=function(){o&&(o.is(":visible")?this.show():this.hide())},this.toggleDOM=function(){this.setMap(this.getMap()?null:e)},this.getDOMElement=function(){return o[0]}}function f(t,e){function i(){return this.onAdd=function(){},this.onRemove=function(){},this.draw=function(){},L.classes.OverlayView.apply(this,[])}i.prototype=L.classes.OverlayView.prototype;var n=new i;return n.setMap(t),n}function g(e,i,o){function r(t){I[t]||(delete k[t].options.map,I[t]=new L.classes.Marker(k[t].options),s(e,{todo:k[t]},I[t],k[t].id))}function a(){return(N=O.getProjection())?(y=!0,C.push(google.maps.event.addListener(i,"zoom_changed",function(){d()})),C.push(google.maps.event.addListener(i,"bounds_changed",function(){d()})),void h()):void setTimeout(function(){a.apply(w,[])},25)}function c(t){"object"==typeof x[t]?("function"==typeof x[t].obj.setMap&&x[t].obj.setMap(null),"function"==typeof x[t].obj.remove&&x[t].obj.remove(),"function"==typeof x[t].shadow.remove&&x[t].obj.remove(),"function"==typeof x[t].shadow.setMap&&x[t].shadow.setMap(null),delete x[t].obj,delete x[t].shadow):I[t]&&I[t].setMap(null),delete x[t]}function l(){var t,e,i,n,o,s,r,a;return arguments[0]instanceof google.maps.LatLng?(t=arguments[0].lat(),i=arguments[0].lng(),arguments[1]instanceof google.maps.LatLng?(e=arguments[1].lat(),n=arguments[1].lng()):(e=arguments[1],n=arguments[2])):(t=arguments[0],i=arguments[1],arguments[2]instanceof google.maps.LatLng?(e=arguments[2].lat(),n=arguments[2].lng()):(e=arguments[2],n=arguments[3])),o=Math.PI*t/180,s=Math.PI*i/180,r=Math.PI*e/180,a=Math.PI*n/180,6371e3*Math.acos(Math.min(Math.cos(o)*Math.cos(r)*Math.cos(s)*Math.cos(a)+Math.cos(o)*Math.sin(s)*Math.cos(r)*Math.sin(a)+Math.sin(o)*Math.sin(r),1))}function u(){var t=l(i.getCenter(),i.getBounds().getNorthEast()),e=new google.maps.Circle({center:i.getCenter(),radius:1.25*t});return e.getBounds()}function p(){var t={},e;for(e in x)t[e]=!0;return t}function d(){clearTimeout(E),E=setTimeout(function(){h()},25)}function g(t){var e=N.fromLatLngToDivPixel(t),i=N.fromDivPixelToLatLng(new google.maps.Point(e.x+o.radius,e.y-o.radius)),n=N.fromDivPixelToLatLng(new google.maps.Point(e.x-o.radius,e.y+o.radius));return new google.maps.LatLngBounds(n,i)}function h(){if(!m&&!b&&y){var e=[],n={},s=i.getZoom(),r="maxZoom"in o&&s>o.maxZoom,a=p(),l,d,f,h,w=!1,C,S,T,P,I,O,E;for(v=!1,s>3&&(C=u(),w=C.getSouthWest().lng()<C.getNorthEast().lng()),l=0;l<k.length;l++)!k[l]||w&&!C.contains(k[l].options.position)||j&&!j(M[l])||e.push(l);for(;;){for(l=0;n[l]&&l<e.length;)l++;if(l==e.length)break;if(h=[],_&&!r){E=10;do for(P=h,h=[],E--,T=P.length?C.getCenter():k[e[l]].options.position,C=g(T),d=l;d<e.length;d++)n[d]||C.contains(k[e[d]].options.position)&&h.push(d);while(P.length<h.length&&h.length>1&&E)}else for(d=l;d<e.length;d++)if(!n[d]){h.push(d);break}for(S={indexes:[],ref:[]},I=O=0,f=0;f<h.length;f++)n[h[f]]=!0,S.indexes.push(e[h[f]]),S.ref.push(e[h[f]]),I+=k[e[h[f]]].options.position.lat(),O+=k[e[h[f]]].options.position.lng();I/=h.length,O/=h.length,S.latLng=new google.maps.LatLng(I,O),S.ref=S.ref.join("-"),S.ref in a?delete a[S.ref]:(1===h.length&&(x[S.ref]=!0),A(S))}t.each(a,function(t){c(t)}),b=!1}}var m=!1,v=!1,b=!1,y=!1,_=!0,w=this,C=[],x={},S={},P={},I=[],k=[],M=[],O=f(i,o.radius),E,N,j,A,z;a(),this.getById=function(t){return t in S?(r(S[t]),I[S[t]]):!1},this.rm=function(t){var e=S[t];I[e]&&I[e].setMap(null),delete I[e],I[e]=!1,delete k[e],k[e]=!1,delete M[e],M[e]=!1,delete S[t],delete P[e],v=!0},this.clearById=function(t){return t in S?(this.rm(t),!0):void 0},this.clear=function(t,e,i){var n,o,s,r,a,c=[],l=T(i);for(t?(n=k.length-1,o=-1,s=-1):(n=0,o=k.length,s=1),r=n;r!=o&&(!k[r]||l&&!l(k[r].tag)||(c.push(P[r]),!e&&!t));r+=s);for(a=0;a<c.length;a++)this.rm(c[a])},this.add=function(t,e){t.id=n(t.id),this.clearById(t.id),S[t.id]=I.length,P[I.length]=t.id,I.push(null),k.push(t),M.push(e),v=!0},this.addMarker=function(t,i){i=i||{},i.id=n(i.id),this.clearById(i.id),i.options||(i.options={}),i.options.position=t.getPosition(),s(e,{todo:i},t,i.id),S[i.id]=I.length,P[I.length]=i.id,I.push(t),k.push(i),M.push(i.data||{}),v=!0},this.todo=function(t){return k[t]},this.value=function(t){return M[t]},this.marker=function(t){return t in I?(r(t),I[t]):!1},this.markerIsSet=function(t){return Boolean(I[t])},this.setMarker=function(t,e){I[t]=e},this.store=function(t,e,i){x[t.ref]={obj:e,shadow:i}},this.free=function(){for(var e=0;e<C.length;e++)google.maps.event.removeListener(C[e]);C=[],t.each(x,function(t){c(t)}),x={},t.each(k,function(t){k[t]=null}),k=[],t.each(I,function(t){I[t]&&(I[t].setMap(null),delete I[t])}),I=[],t.each(M,function(t){delete M[t]}),M=[],S={},P={}},this.filter=function(t){j=t,h()},this.enable=function(t){_!=t&&(_=t,h())},this.display=function(t){A=t},this.error=function(t){z=t},this.beginUpdate=function(){m=!0},this.endUpdate=function(){m=!1,v&&h()},this.autofit=function(t){for(var e=0;e<k.length;e++)k[e]&&t.extend(k[e].options.position)}}function h(t,e){this.id=function(){return t},this.filter=function(t){e.filter(t)},this.enable=function(){e.enable(!0)},this.disable=function(){e.enable(!1)},this.add=function(t,i,n){n||e.beginUpdate(),e.addMarker(t,i),n||e.endUpdate()},this.getById=function(t){return e.getById(t)},this.clearById=function(t,i){var n;return i||e.beginUpdate(),n=e.clearById(t),i||e.endUpdate(),n},this.clear=function(t,i,n,o){o||e.beginUpdate(),e.clear(t,i,n),o||e.endUpdate()}}function m(){function i(t){return{id:t.id,name:t.name,object:t.obj,tag:t.tag,data:t.data}}function o(t){"function"==typeof t.setMap&&t.setMap(null),"function"==typeof t.remove&&t.remove(),"function"==typeof t.free&&t.free(),t=null}var s={},r={};this.add=function(t,e,i,o){var a=t.todo||{},c=n(a.id);return s[e]||(s[e]=[]),c in r&&this.clearById(c),r[c]={obj:i,sub:o,name:e,id:c,tag:a.tag,data:a.data},s[e].push(c),c},this.getById=function(t,e,n){return t in r?e?r[t].sub:n?i(r[t]):r[t].obj:!1},this.get=function(t,e,n,o){var a,c,l=T(n);if(!s[t]||!s[t].length)return null;for(a=s[t].length;a;)if(a--,c=s[t][e?a:s[t].length-a-1],c&&r[c]){if(l&&!l(r[c].tag))continue;return o?i(r[c]):r[c].obj}return null},this.all=function(t,n,o){var a=[],c=T(n),l=function(t){var e,n;for(e=0;e<s[t].length;e++)if(n=s[t][e],n&&r[n]){if(c&&!c(r[n].tag))continue;a.push(o?i(r[n]):r[n].obj)}};if(t in s)l(t);else if(t===e)for(t in s)l(t);return a},this.rm=function(t,e,i){var n,o;if(!s[t])return!1;if(e)if(i)for(n=s[t].length-1;n>=0&&(o=s[t][n],!e(r[o].tag));n--);else for(n=0;n<s[t].length&&(o=s[t][n],!e(r[o].tag));n++);else n=i?s[t].length-1:0;return n in s[t]?this.clearById(s[t][n],n):!1},this.clearById=function(t,i){if(t in r){var n,a=r[t].name;for(n=0;i===e&&n<s[a].length;n++)t===s[a][n]&&(i=n);return o(r[t].obj),r[t].sub&&o(r[t].sub),delete r[t],s[a].splice(i,1),!0}return!1},this.objGetById=function(t){var e;if(s.clusterer)for(var i in s.clusterer)if((e=r[s.clusterer[i]].obj.getById(t))!==!1)return e;return!1},this.objClearById=function(t){if(s.clusterer)for(var e in s.clusterer)if(r[s.clusterer[e]].obj.clearById(t))return!0;return null},this.clear=function(t,e,i,n){var o,r,a,c=T(n);if(t&&t.length)t=S(t);else{t=[];for(o in s)t.push(o)}for(r=0;r<t.length;r++)if(a=t[r],e)this.rm(a,c,!0);else if(i)this.rm(a,c,!1);else for(;this.rm(a,c,!1););},this.objClear=function(e,i,n,o){if(s.clusterer&&(t.inArray("marker",e)>=0||!e.length))for(var a in s.clusterer)r[s.clusterer[a]].obj.clear(i,n,o)}}function v(){return A.geocoder||(A.geocoder=new google.maps.Geocoder),A.geocoder}function b(){return A.directionsService||(A.directionsService=new google.maps.DirectionsService),A.directionsService}function y(){return A.elevationService||(A.elevationService=new google.maps.ElevationService),A.elevationService}function _(){return A.maxZoomService||(A.maxZoomService=new google.maps.MaxZoomService),A.maxZoomService}function w(){return A.distanceMatrixService||(A.distanceMatrixService=new google.maps.DistanceMatrixService),A.distanceMatrixService}function C(){if(L.verbose){var t,e=[];if(window.console&&"function"==typeof console.error){for(t=0;t<arguments.length;t++)e.push(arguments[t]);console.error.apply(console,e)}else{for(e="",t=0;t<arguments.length;t++)e+=arguments[t].toString()+" ";alert(e)}}}function x(t){return("number"==typeof t||"string"==typeof t)&&""!==t&&!isNaN(t)}function S(t){var i,n=[];if(t!==e)if("object"==typeof t)if("number"==typeof t.length)n=t;else for(i in t)n.push(t[i]);else n.push(t);return n}function T(i){return i?"function"==typeof i?i:(i=S(i),function(n){if(n===e)return!1;if("object"==typeof n){for(var o=0;o<n.length;o++)if(t.inArray(n[o],i)>=0)return!0;return!1}return t.inArray(n,i)>=0}):void 0}function P(e,i,n){var o=i?e:null;return e&&"string"!=typeof e?e.latLng?P(e.latLng):e instanceof google.maps.LatLng?e:x(e.lat)?new google.maps.LatLng(e.lat,e.lng):!n&&t.isArray(e)&&x(e[0])&&x(e[1])?new google.maps.LatLng(e[0],e[1]):o:o}function I(e){var i,n;return!e||e instanceof google.maps.LatLngBounds?e||null:(t.isArray(e)?2==e.length?(i=P(e[0]),n=P(e[1])):4==e.length&&(i=P([e[0],e[1]]),n=P([e[2],e[3]])):"ne"in e&&"sw"in e?(i=P(e.ne),n=P(e.sw)):"n"in e&&"e"in e&&"s"in e&&"w"in e&&(i=P([e.n,e.e]),n=P([e.s,e.w])),i&&n?new google.maps.LatLngBounds(n,i):null)}function k(t,e,i,n,o){var s=i?P(n.todo,!1,!0):!1,r=s?{latLng:s}:n.todo.address?"string"==typeof n.todo.address?{address:n.todo.address}:n.todo.address:!1,a=r?z.get(r):!1,c=this;r?(o=o||0,a?(n.latLng=a.results[0].geometry.location,n.results=a.results,n.status=a.status,e.apply(t,[n])):(r.location&&(r.location=P(r.location)),r.bounds&&(r.bounds=I(r.bounds)),v().geocode(r,function(s,a){a===google.maps.GeocoderStatus.OK?(z.store(r,{results:s,status:a}),n.latLng=s[0].geometry.location,n.results=s,n.status=a,e.apply(t,[n])):a===google.maps.GeocoderStatus.OVER_QUERY_LIMIT&&o<L.queryLimit.attempt?setTimeout(function(){k.apply(c,[t,e,i,n,o+1])},L.queryLimit.delay+Math.floor(Math.random()*L.queryLimit.random)):(C("geocode failed",a,r),n.latLng=n.results=!1,n.status=a,e.apply(t,[n]))}))):(n.latLng=P(n.todo,!1,!0),e.apply(t,[n]))}function M(e,i,n,o){function s(){do a++;while(a<e.length&&!("address"in e[a]));return a>=e.length?void n.apply(i,[o]):void k(r,function(i){delete i.todo,t.extend(e[a],i),s.apply(r,[])},!0,{todo:e[a]})}var r=this,a=-1;s()}function O(t,e,i){var n=!1;navigator&&navigator.geolocation?navigator.geolocation.getCurrentPosition(function(o){n||(n=!0,i.latLng=new google.maps.LatLng(o.coords.latitude,o.coords.longitude),e.apply(t,[i]))},function(){n||(n=!0,i.latLng=!1,e.apply(t,[i]))},i.opts.getCurrentPosition):(i.latLng=!1,e.apply(t,[i]))}function E(i){function c(){!N&&(N=M.get())&&N.run()}function u(){N=null,M.ack(),c.call(k)}function p(e){if(e.todo.callback){var n=Array.prototype.slice.call(arguments,1);"function"==typeof e.todo.callback?e.todo.callback.apply(i,n):t.isArray(e.todo.callback)&&"function"==typeof e.todo.callback[1]&&e.todo.callback[1].apply(e.todo.callback[0],n)}}function f(t,e,n){n&&s(i,t,e,n),p(t,e),N.ack(e)}function v(e,n){if(n=n||{},E)n.todo&&n.todo.options&&(n.todo.options.center&&(n.todo.options.center=P(n.todo.options.center)),E.setOptions(n.todo.options));else{var o=n.opts||t.extend(!0,{},L.map,n.todo&&n.todo.options?n.todo.options:{});o.center=e||P(o.center),E=new L.classes.Map(i.get(0),o)}}function x(e,n,o){var r=[],a="values"in e.todo;return a||(e.todo.values=[{options:e.opts}]),e.todo.values.length?(v(),t.each(e.todo.values,function(a,c){var u,p,d,f,g=l(e,c);if(g.options[o])if(g.options[o][0][0]&&t.isArray(g.options[o][0][0]))for(p=0;p<g.options[o].length;p++)for(d=0;d<g.options[o][p].length;d++)g.options[o][p][d]=P(g.options[o][p][d]);else for(p=0;p<g.options[o].length;p++)g.options[o][p]=P(g.options[o][p]);g.options.map=E,f=new google.maps[n](g.options),r.push(f),u=O.add({todo:g},n.toLowerCase(),f),s(i,{todo:g},f,u)}),void f(e,a?r:r[0])):void f(e,!1)}function T(n){var o=new g(i,E,n),r={},a={},c=[],l=/^[0-9]+$/,u,p;for(p in n)l.test(p)?(c.push(1*p),a[p]=n[p],a[p].width=a[p].width||0,a[p].height=a[p].height||0):r[p]=n[p];return c.sort(function(t,e){return t>e}),u=r.calculator?function(e){var n=[];return t.each(e,function(t,e){n.push(o.value(e))}),r.calculator.apply(i,[n])}:function(t){return t.length},o.error(function(){C.apply(k,arguments)}),o.display(function(l){var p,d,f,g,h,m=u(l.indexes);if(n.force||m>1)for(p=0;p<c.length;p++)c[p]<=m&&(d=a[c[p]]);d?(h=d.offset||[-d.width/2,-d.height/2],f=t.extend({},r),f.options=t.extend({pane:"overlayLayer",content:d.content?d.content.replace("CLUSTER_COUNT",m):"",offset:{x:("x"in h?h.x:h[0])||0,y:("y"in h?h.y:h[1])||0}},r.options||{}),g=k.overlay({todo:f,opts:f.options,latLng:P(l)},!0),f.options.pane="floatShadow",f.options.content=t(document.createElement("div")).width(d.width+"px").height(d.height+"px").css({cursor:"pointer"}),shadow=k.overlay({todo:f,opts:f.options,latLng:P(l)},!0),r.data={latLng:P(l),markers:[]},t.each(l.indexes,function(t,e){r.data.markers.push(o.value(e)),o.markerIsSet(e)&&o.marker(e).setMap(null)}),s(i,{todo:r},shadow,e,{main:g,shadow:shadow}),o.store(l,g,shadow)):t.each(l.indexes,function(t,e){o.marker(e).setMap(E)})}),o}var k=this,M=new r,O=new m,E=null,N;this._plan=function(t){for(var e=0;e<t.length;e++)M.add(new a(k,u,t[e]));c()},this.map=function(t){v(t.latLng,t),s(i,t,E),f(t,E)},this.destroy=function(t){O.clear(),i.empty(),E&&(E=null),f(t,!0)},this.infowindow=function(n){var o=[],r="values"in n.todo;r||(n.latLng&&(n.opts.position=n.latLng),n.todo.values=[{options:n.opts}]),t.each(n.todo.values,function(t,a){var c,u,p=l(n,a);p.options.position=P(p.options.position?p.options.position:a.latLng),E||v(p.options.position),u=new L.classes.InfoWindow(p.options),u&&(p.open===e||p.open)&&(r?u.open(E,p.anchor?p.anchor:e):u.open(E,p.anchor?p.anchor:n.latLng?e:n.session.marker?n.session.marker:e)),o.push(u),c=O.add({todo:p},"infowindow",u),s(i,{todo:p},u,c)}),f(n,r?o:o[0])},this.circle=function(e){var n=[],o="values"in e.todo;return o||(e.opts.center=e.latLng||P(e.opts.center),e.todo.values=[{options:e.opts}]),e.todo.values.length?(t.each(e.todo.values,function(t,o){var r,a,c=l(e,o);c.options.center=P(c.options.center?c.options.center:o),E||v(c.options.center),c.options.map=E,a=new L.classes.Circle(c.options),n.push(a),r=O.add({todo:c},"circle",a),s(i,{todo:c},a,r)}),void f(e,o?n:n[0])):void f(e,!1)},this.overlay=function(e,n){var o=[],r="values"in e.todo;return r||(e.todo.values=[{latLng:e.latLng,options:e.opts}]),e.todo.values.length?(d.__initialised||(d.prototype=new L.classes.OverlayView,d.__initialised=!0),t.each(e.todo.values,function(r,a){var c,u,p=l(e,a),f=t(document.createElement("div")).css({border:"none",borderWidth:"0px",position:"absolute"});f.append(p.options.content),u=new d(E,p.options,P(p)||P(a),f),o.push(u),f=null,n||(c=O.add(e,"overlay",u),s(i,{todo:p},u,c))}),n?o[0]:void f(e,r?o:o[0])):void f(e,!1)},this.getaddress=function(t){p(t,t.results,t.status),N.ack()},this.getlatlng=function(t){p(t,t.results,t.status),N.ack()},this.getmaxzoom=function(t){_().getMaxZoomAtLatLng(t.latLng,function(e){p(t,e.status===google.maps.MaxZoomStatus.OK?e.zoom:!1,status),N.ack()})},this.getelevation=function(t){var e,i=[],n=function(e,i){p(t,i===google.maps.ElevationStatus.OK?e:!1,i),N.ack()};if(t.latLng)i.push(t.latLng);else for(i=S(t.todo.locations||[]),e=0;e<i.length;e++)i[e]=P(i[e]);if(i.length)y().getElevationForLocations({locations:i},n);else{if(t.todo.path&&t.todo.path.length)for(e=0;e<t.todo.path.length;e++)i.push(P(t.todo.path[e]));i.length?y().getElevationAlongPath({path:i,samples:t.todo.samples},n):N.ack()}},this.defaults=function(e){t.each(e.todo,function(e,i){L[e]="object"==typeof L[e]?t.extend({},L[e],i):i}),N.ack(!0)},this.rectangle=function(e){var n=[],o="values"in e.todo;return o||(e.todo.values=[{options:e.opts}]),e.todo.values.length?(t.each(e.todo.values,function(t,o){var r,a,c=l(e,o);c.options.bounds=I(c.options.bounds?c.options.bounds:o),E||v(c.options.bounds.getCenter()),c.options.map=E,a=new L.classes.Rectangle(c.options),n.push(a),r=O.add({todo:c},"rectangle",a),s(i,{todo:c},a,r)
}),void f(e,o?n:n[0])):void f(e,!1)},this.polyline=function(t){x(t,"Polyline","path")},this.polygon=function(t){x(t,"Polygon","paths")},this.trafficlayer=function(t){v();var e=O.get("trafficlayer");e||(e=new L.classes.TrafficLayer,e.setMap(E),O.add(t,"trafficlayer",e)),f(t,e)},this.bicyclinglayer=function(t){v();var e=O.get("bicyclinglayer");e||(e=new L.classes.BicyclingLayer,e.setMap(E),O.add(t,"bicyclinglayer",e)),f(t,e)},this.groundoverlay=function(t){t.opts.bounds=I(t.opts.bounds),t.opts.bounds&&v(t.opts.bounds.getCenter());var e,i=new L.classes.GroundOverlay(t.opts.url,t.opts.bounds,t.opts.opts);i.setMap(E),e=O.add(t,"groundoverlay",i),f(t,i,e)},this.streetviewpanorama=function(e){e.opts.opts||(e.opts.opts={}),e.latLng?e.opts.opts.position=e.latLng:e.opts.opts.position&&(e.opts.opts.position=P(e.opts.opts.position)),e.todo.divId?e.opts.container=document.getElementById(e.todo.divId):e.opts.container&&(e.opts.container=t(e.opts.container).get(0));var i,n=new L.classes.StreetViewPanorama(e.opts.container,e.opts.opts);n&&E.setStreetView(n),i=O.add(e,"streetviewpanorama",n),f(e,n,i)},this.kmllayer=function(e){var n=[],r="values"in e.todo;return r||(e.todo.values=[{options:e.opts}]),e.todo.values.length?(t.each(e.todo.values,function(t,r){var a,c,u,p=l(e,r);E||v(),u=p.options,p.options.opts&&(u=p.options.opts,p.options.url&&(u.url=p.options.url)),u.map=E,c=o("3.10")?new L.classes.KmlLayer(u):new L.classes.KmlLayer(u.url,u),n.push(c),a=O.add({todo:p},"kmllayer",c),s(i,{todo:p},c,a)}),void f(e,r?n:n[0])):void f(e,!1)},this.panel=function(n){v();var o,s=0,r=0,a,c=t(document.createElement("div"));c.css({position:"absolute",zIndex:1e3,visibility:"hidden"}),n.opts.content&&(a=t(n.opts.content),c.append(a),i.first().prepend(c),n.opts.left!==e?s=n.opts.left:n.opts.right!==e?s=i.width()-a.width()-n.opts.right:n.opts.center&&(s=(i.width()-a.width())/2),n.opts.top!==e?r=n.opts.top:n.opts.bottom!==e?r=i.height()-a.height()-n.opts.bottom:n.opts.middle&&(r=(i.height()-a.height())/2),c.css({top:r,left:s,visibility:"visible"})),o=O.add(n,"panel",c),f(n,c,o),c=null},this.marker=function(e){var o="values"in e.todo,r=!E;if(o||(e.opts.position=e.latLng||P(e.opts.position),e.todo.values=[{options:e.opts}]),!e.todo.values.length)return void f(e,!1);if(r&&v(),e.todo.cluster&&!E.getBounds())return void google.maps.event.addListenerOnce(E,"bounds_changed",function(){k.marker.apply(k,[e])});if(e.todo.cluster){var a,c;e.todo.cluster instanceof h?(a=e.todo.cluster,c=O.getById(a.id(),!0)):(c=T(e.todo.cluster),a=new h(n(e.todo.id,!0),c),O.add(e,"clusterer",a,c)),c.beginUpdate(),t.each(e.todo.values,function(t,i){var n=l(e,i);n.options.position=P(n.options.position?n.options.position:i),n.options.map=E,r&&(E.setCenter(n.options.position),r=!1),c.add(n,i)}),c.endUpdate(),f(e,a)}else{var u=[];t.each(e.todo.values,function(t,n){var o,a,c=l(e,n);c.options.position=P(c.options.position?c.options.position:n),c.options.map=E,r&&(E.setCenter(c.options.position),r=!1),a=new L.classes.Marker(c.options),u.push(a),o=O.add({todo:c},"marker",a),s(i,{todo:c},a,o)}),f(e,o?u:u[0])}},this.getroute=function(t){t.opts.origin=P(t.opts.origin,!0),t.opts.destination=P(t.opts.destination,!0),b().route(t.opts,function(e,i){p(t,i==google.maps.DirectionsStatus.OK?e:!1,i),N.ack()})},this.directionsrenderer=function(e){e.opts.map=E;var i,n=new google.maps.DirectionsRenderer(e.opts);e.todo.divId?n.setPanel(document.getElementById(e.todo.divId)):e.todo.container&&n.setPanel(t(e.todo.container).get(0)),i=O.add(e,"directionsrenderer",n),f(e,n,i)},this.getgeoloc=function(t){f(t,t.latLng)},this.styledmaptype=function(t){v();var e=new L.classes.StyledMapType(t.todo.styles,t.opts);E.mapTypes.set(t.todo.id,e),f(t,e)},this.imagemaptype=function(t){v();var e=new L.classes.ImageMapType(t.opts);E.mapTypes.set(t.todo.id,e),f(t,e)},this.autofit=function(e){var i=new google.maps.LatLngBounds;t.each(O.all(),function(t,e){e.getPosition?i.extend(e.getPosition()):e.getBounds?(i.extend(e.getBounds().getNorthEast()),i.extend(e.getBounds().getSouthWest())):e.getPaths?e.getPaths().forEach(function(t){t.forEach(function(t){i.extend(t)})}):e.getPath?e.getPath().forEach(function(t){i.extend(t)}):e.getCenter?i.extend(e.getCenter()):e instanceof h&&(e=O.getById(e.id(),!0),e&&e.autofit(i))}),i.isEmpty()||E.getBounds()&&E.getBounds().equals(i)||("maxZoom"in e.todo&&google.maps.event.addListenerOnce(E,"bounds_changed",function(){this.getZoom()>e.todo.maxZoom&&this.setZoom(e.todo.maxZoom)}),E.fitBounds(i)),f(e,!0)},this.clear=function(e){if("string"==typeof e.todo){if(O.clearById(e.todo)||O.objClearById(e.todo))return void f(e,!0);e.todo={name:e.todo}}e.todo.id?t.each(S(e.todo.id),function(t,e){O.clearById(e)||O.objClearById(e)}):(O.clear(S(e.todo.name),e.todo.last,e.todo.first,e.todo.tag),O.objClear(S(e.todo.name),e.todo.last,e.todo.first,e.todo.tag)),f(e,!0)},this.exec=function(e){var n=this;t.each(S(e.todo.func),function(o,s){t.each(n.get(e.todo,!0,e.todo.hasOwnProperty("full")?e.todo.full:!0),function(t,e){s.call(i,e)})}),f(e,!0)},this.get=function(i,n,o){var s,r,a=n?i:i.todo;return n||(o=a.full),"string"==typeof a?(r=O.getById(a,!1,o)||O.objGetById(a),r===!1&&(s=a,a={})):s=a.name,"map"===s&&(r=E),r||(r=[],a.id?(t.each(S(a.id),function(t,e){r.push(O.getById(e,!1,o)||O.objGetById(e))}),t.isArray(a.id)||(r=r[0])):(t.each(s?S(s):[e],function(e,i){var n;a.first?(n=O.get(i,!1,a.tag,o),n&&r.push(n)):a.all?t.each(O.all(i,a.tag,o),function(t,e){r.push(e)}):(n=O.get(i,!0,a.tag,o),n&&r.push(n))}),a.all||t.isArray(s)||(r=r[0]))),r=t.isArray(r)||!a.all?r:[r],n?r:void f(i,r)},this.getdistance=function(t){var e;for(t.opts.origins=S(t.opts.origins),e=0;e<t.opts.origins.length;e++)t.opts.origins[e]=P(t.opts.origins[e],!0);for(t.opts.destinations=S(t.opts.destinations),e=0;e<t.opts.destinations.length;e++)t.opts.destinations[e]=P(t.opts.destinations[e],!0);w().getDistanceMatrix(t.opts,function(e,i){p(t,i===google.maps.DistanceMatrixStatus.OK?e:!1,i),N.ack()})},this.trigger=function(e){if("string"==typeof e.todo)google.maps.event.trigger(E,e.todo);else{var i=[E,e.todo.eventName];e.todo.var_args&&t.each(e.todo.var_args,function(t,e){i.push(e)}),google.maps.event.trigger.apply(google.maps.event,i)}p(e),N.ack()}}function N(t){var e;if(!t.hasOwnProperty("get"))return!1;for(e in t)if("get"!==e)return!1;return!t.get.hasOwnProperty("callback")}var L,j=0,A={},z=new p;t.fn.gmap3=function(){var e,n=[],o=!0,s=[];for(i(),e=0;e<arguments.length;e++)arguments[e]&&n.push(arguments[e]);return n.length||n.push("map"),t.each(this,function(){var e=t(this),i=e.data("gmap3");o=!1,i||(i=new E(e),e.data("gmap3",i)),1!==n.length||"get"!==n[0]&&!N(n[0])?i._plan(n):s.push("get"===n[0]?i.get("map",!0):i.get(n[0].get,!0,n[0].get.full))}),s.length?1===s.length?s[0]:s:this}}(jQuery);var scrolltotop={setting:{startline:200,scrollto:0,scrollduration:1200,fadeduration:[500,100]},controlHTML:'<div class="to_the_top"><div class="icon-arrow-up"></div></div>',controlattrs:{offsetx:0,offsety:52},anchorkeyword:"#top",state:{isvisible:!1,shouldvisible:!1},scrollup:function(){this.cssfixedsupport||this.$control.css({opacity:0});var t=isNaN(this.setting.scrollto)?this.setting.scrollto:parseInt(this.setting.scrollto);t="string"==typeof t&&1==jQuery("#"+t).length?jQuery("#"+t).offset().top:0,this.$body.animate({scrollTop:t},this.setting.scrollduration)},keepfixed:function(){var t=jQuery(window),e=t.scrollLeft()+t.width()-this.$control.width()-this.controlattrs.offsetx,i=t.scrollTop()+t.height()-this.$control.height()-this.controlattrs.offsety;this.$control.css({left:e+"px",top:i+"px"})},togglecontrol:function(){var t=jQuery(window).scrollTop();this.cssfixedsupport||this.keepfixed(),this.state.shouldvisible=t>=this.setting.startline?!0:!1,this.state.shouldvisible&&!this.state.isvisible?(this.$control.stop().animate({opacity:1},this.setting.fadeduration[0]),this.state.isvisible=!0):0==this.state.shouldvisible&&this.state.isvisible&&(this.$control.stop().animate({opacity:0},this.setting.fadeduration[1]),this.state.isvisible=!1)},init:function(){jQuery(document).ready(function($){var t=scrolltotop,e=document.all;t.cssfixedsupport=!e||e&&"CSS1Compat"==document.compatMode&&window.XMLHttpRequest,t.$body=$(window.opera?"CSS1Compat"==document.compatMode?"html":"body":"html,body"),t.$control=$('<div id="topcontrol">'+t.controlHTML+"</div>").css({position:t.cssfixedsupport?"fixed":"absolute",bottom:t.controlattrs.offsety,right:t.controlattrs.offsetx,opacity:0,cursor:"pointer"}).attr({title:"To the top!"}).click(function(){return t.scrollup(),!1}).appendTo("body"),document.all&&!window.XMLHttpRequest&&""!=t.$control.text()&&t.$control.css({width:t.$control.width()}),t.togglecontrol(),$('a[href="'+t.anchorkeyword+'"]').click(function(){return t.scrollup(),!1}),$(window).bind("scroll resize",function(e){t.togglecontrol()})})}};scrolltotop.init();